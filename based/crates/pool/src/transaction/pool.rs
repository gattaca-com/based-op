...
impl TxPool {
    ...
    pub fn handle_new_tx<Db: DatabaseRead>(
        ...
        metrics_aggregator: &mut MetricsAggregator,
    ) -> bool {
        ...
        // Update metrics in aggregator
        metrics_aggregator.set_active_tx_count(self.active_txs.num_txs());
        ...
        metrics_aggregator.set_pool_memory_bytes(estimated_memory);
