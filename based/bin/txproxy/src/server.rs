...
use crate::{cli::TxProxy, middleware::ProxyService};
...
impl TxProxyServer {
    pub async fn new(args: TxProxy) -> eyre::Result<Self> {
...
#[async_trait]
impl EthApiServer for TxProxyServer {
...
#[async_trait]
impl EngineApiServer for TxProxyServer {
    #[tracing::instrument(skip_all, err, ret(level = Level::DEBUG), fields(req_id = %uuid()))]
...
#[async_trait]
impl PortalApiServer for TxProxyServer {
...
#[async_trait]
impl RegistryApiServer for TxProxyServer {
