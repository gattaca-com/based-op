...
use bop_common::{communication::Consumer, time::{Duration, Instant, Nanos}};
...
impl<T: Statisticable> Default for DataPoint<T> {
    fn default() -> Self {
        Self { avg: 0, min: u64::MAX, max: 0, median: 0, n_samples: 0, vline: false, rate: Default::default(), _p: PhantomData {} }
    }
}
