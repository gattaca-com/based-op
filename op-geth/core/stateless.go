...
func ExecuteStateless(config *params.ChainConfig, block *types.Block, witness *stateless.Witness, isUnsealed bool) (common.Hash, common.Hash, error) {
	...
	res, err := processor.Process(block, db, vm.Config{}, isUnsealed)
	if err != nil {
		return common.Hash{}, common.Hash{}, err
	}
